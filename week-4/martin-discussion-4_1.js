...
; Process the queue array moving the values to the processedValues array and outputting the value and the length of the queue array.
;
...
while(queue.length){
  ...
  console.log(`Item ${item} has been processed, there are ${queue.} items remaining the queue.`)
}
